...
function Signup() {
  ...
  const [roleType, setRoleType] = useState('finder'); // Default role
  ...
  const handleSignup = async (e) => {
    ...
    const payload = {
      ...
      email,
      password,
      role_type: roleType === 'I am here for jobs' ? 'finder' : 'seeker',
    };
    ...
    try {
      ...
      if (roleType === 'finder') {
        ...
        Object.keys(data).forEach((key) => {
          localStorage.setItem(`recruiter_${key}`, data[key]);
        });
      }
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="role">
                      What brings you here?<span className="text-rose-500">*</span>
                    </label>
                    <select
                      id="role"
                    ...
                    >
                      <option>I am here for jobs</option>
                      <option>I am here for candidates</option>
                    </select>
                  </div>
                  <div>
                ...
                <div className="flex items-center justify-between mt-6">
                  <div className="mr-1">
                    <label className="flex items-center">
                      ...
                      <span className="text-sm ml-2">Keep me signed in.</span>
                    </label>
                  </div>
                  <button
                    type="submit"
