...
function Onboarding01() {
  ...
  const handleNextStep = () => {
    if (aboutMe.trim().length > 0) {
      localStorage.setItem('about_me', aboutMe.trim());
      navigate('/onboarding-02');
    } else {
      alert('Please write something about yourself before proceeding.');
    }
  };
          ...
          <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                <h1 className="text-3xl text-slate-800 font-bold mb-6">Tell us about yourself ✨</h1>
                {/* About Me Textbox */}
                <div className="mb-6">
                  <label className="block text-sm font-medium mb-2" htmlFor="about-me">
                  ...
                  ></textarea>
                  <p className="text-sm text-gray-500 mt-1">{aboutMe.length}/500 characters</p>
                </div>
