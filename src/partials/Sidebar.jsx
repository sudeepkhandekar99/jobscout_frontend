...
function Sidebar({
  ...
  const profileLinkTo = lastLogin === 'user' ? '/community/profile' : '/job/company-profile';
  const listingLinkTo = lastLogin === 'user' ? '/job/job-listing-user' : '/job/job-listing';
  const isScouter = lastLogin === 'user' ? 'yes' : 'no';
  const isUser = lastLogin === 'user' ? 'yes' : 'no';
