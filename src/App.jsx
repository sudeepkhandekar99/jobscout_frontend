...
import JobListingUser from './pages/job/JobListingUser';
...
import Onboarding06 from './pages/Onboarding06';
import Onboarding07 from './pages/Onboarding07';
import Onboarding08 from './pages/Onboarding08';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/job/job-listing-user" element={<JobListingUser />} />
        ...
        <Route path="/onboarding-org-01" element={<Onboarding05 />} />
        <Route path="/onboarding-org-02" element={<Onboarding06 />} />
        <Route path="/onboarding-org-03" element={<Onboarding07 />} />
        <Route path="/onboarding-org-04" element={<Onboarding08 />} />
